...
export const CONSTRAINTS = [
  ...
  },
  {
    ...
    kind: "structural",
    reads: ["tab", "pick"],
    title: "Step selection needs the pipeline tab",
    why: "The Relations tab is the shared read-only relation renderer; it has no step to select.",
  ...
  },
  {
    ...
    kind: "structural",
    reads: ["tab", "edit"],
    title: "Mutation needs the pipeline tab",
    why: "Editing happens in the pipeline editor and the existing forms — never on the relation graph.",
