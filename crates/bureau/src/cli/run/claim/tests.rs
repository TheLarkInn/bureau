...
fn occupied(fixture: &Fixture) {
    fixture
        .store
        .record_run("completed", "manual", 1.0)
        .expect("recorded budget");
    assert!(
        fixture
            .store
            .try_claim("manual", "github", "held", Duration::from_secs(60))
