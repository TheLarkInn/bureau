#!/usr/bin/env bash
# Every lint gate CI enforces, in one command: repository policy, formatting,
# clippy, and the dylint custom lints (lints/rust-lints, configured by
# dylint.toml). Mirrors .github/workflows/rust-lints.yml — CI runs this same
